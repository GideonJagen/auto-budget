...
class AutoBudget():
    ...
    def make_compilation(self):
        ...
        for date, cost_center_list in self.budget_dict.items():
            ...
            for cost_type, cost in month_cost_dict.items():
                if cost_type in existing_cost_types.keys():
                        ...
                        compilation_sheet.cell(existing_cost_types.get(cost_type), column_index).style = 'Comma [0]'
                else:
                    ...
                    compilation_sheet.cell(row_index, column_index, cost).style = 'Comma [0]'
            ...
            for i, cost_center_dict in enumerate(cost_center_list):
                ...
                for index, row in cost_center_dict[cost_center_dict['id']].iterrows():
                    ...
                    if actual_cost:
                        ...
                        compilation_sheet.cell(existing_cost_types.get(index), column_index + offset, actual_cost).style = 'Comma [0]'
        ...
        for col in range(self.offset+1,compilation_sheet.max_column+1):
            ...
            compilation_sheet.cell(row, col, f"=SUM({column_letter}{2}:{column_letter}{row-2})").style = 'Comma [0]'
